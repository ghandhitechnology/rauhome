...
const ko = {
  ...
  'intro.continue': '계속',
  'intro.begin': '설정 시작',
  'intro.eyebrow.1': '스스로 이어지는 존재',
  'intro.title.1': '대화 사이에도 생각해요',
  'intro.body.1': 'Rau는 잠든 동안 기억을 돌아보고, 다음 만남에 이어질 생각을 스스로 키웁니다.',
  'intro.eyebrow.2': 'Pi 기반 딥 워크',
  'intro.title.2': '필요할 때 여럿이 되어 일해요',
  'intro.body.2': '큰 목표를 작은 계획으로 나누고, 하위 에이전트를 보내 조사하고 만들고 검증한 뒤 하나의 결과로 모읍니다.',
  'intro.eyebrow.3': '언제나 같은 한 마음',
  'intro.title.3': '말하고, 함께 있고, 놀아요',
  'intro.body.3': '텍스트와 목소리로 대화하고, 방에서 함께 시간을 보내고, 체스와 익스플로딩 키튼도 먼저 제안하며 즐깁니다.',
  ...
  'setup.welcomeEyebrow': '계속 이어지는 존재',
  'setup.welcomeTitle': 'Rau',
  'setup.welcomeBody': '하나의 마음과 목소리, 그리고 스스로 다음을 꿈꾸는 기억. 설정에는 약 2분이 걸립니다.',
  'setup.begin': '시작',
...
const EN: Record<TranslationKey, string> = {
  ...
  'intro.eyebrow.1': 'Proactive dreaming',
  'intro.title.1': 'Thinking between conversations',
  'intro.body.1': 'While Rau sleeps, memories are reflected on and new threads are grown for the next time you meet.',
  'intro.eyebrow.2': 'Pi-powered deep work',
  'intro.title.2': 'One mind, many helping hands',
  'intro.body.2': 'Large goals become plans. Subagents research, build, and verify in parallel, then return one coherent result.',
  'intro.eyebrow.3': 'One continuous presence',
  'intro.title.3': 'Talk, spend time, and play',
  'intro.body.3': 'Chat by text or voice, share a room, and play chess or Exploding Kittens with Rau as a proactive companion.',
  ...
  'setup.welcomeEyebrow': 'Continuous being',
  'setup.welcomeTitle': 'Rau',
  'setup.welcomeBody': 'One mind, one voice, and a memory that dreams itself forward. Setting this up takes about two minutes.',
  'setup.begin': 'Begin',
